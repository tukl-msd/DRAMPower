...
InterfaceCalculation_HBM2::InterfaceCalculation_HBM2(const MemSpecHBM2 &memspec) :
    memspec_(memspec), 
...
interface_energy_info_t InterfaceCalculation_HBM2::calcClockEnergy(const SimulationStats &stats) {
    interface_energy_info_t result;
    // Pull up -> zeros
...
interface_energy_info_t InterfaceCalculation_HBM2::calcClockEnableEnergy(const SimulationStats &stats) {
    ...
    // Pull up -> zeros
    result.controller.staticEnergy =
        calcStaticTermination(impedances_.cke_termination, stats.cke, impedances_.cke_R_eq, t_CK_, 1, VDD_);
    result.controller.dynamicEnergy =
...
interface_energy_info_t InterfaceCalculation_HBM2::calcDQSEnergy(const SimulationStats &stats) {
    interface_energy_info_t result;
...
interface_energy_info_t InterfaceCalculation_HBM2::calcDQEnergyTogglingRate(const TogglingStats &stats)
{
    interface_energy_info_t result;
...
interface_energy_info_t InterfaceCalculation_HBM2::calcDQEnergy(const SimulationStats &stats) {
    interface_energy_info_t result;
    // Read
    result.dram.staticEnergy +=
...
interface_energy_info_t InterfaceCalculation_HBM2::calcCAEnergy(const SimulationStats &stats) {
    interface_energy_info_t result;
    // Pull up -> zeros
    result.controller.staticEnergy =
...
interface_energy_info_t InterfaceCalculation_HBM2::calcDBIEnergy(const SimulationStats &stats) {
    interface_energy_info_t result;
    // Read
    result.dram.staticEnergy +=
