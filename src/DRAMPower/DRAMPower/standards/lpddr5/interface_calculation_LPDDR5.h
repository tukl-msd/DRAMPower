...
namespace DRAMPower
{
    ...
    class InterfacePowerCalculation_LPDDR5
    {
    private:
        double VDDQ;
        double t_CK;

        MemSpecLPDDR5::MemImpedanceSpec impedanceSpec;
    private:
        // nur f�r LPDDR4
    ...
    public:
        InterfacePowerCalculation_LPDDR5(const MemSpecLPDDR5 & memspec)
        {
            VDDQ = memspec.memPowerSpec[MemSpecLPDDR5::VoltageDomain::VDDQ].vDDX;
