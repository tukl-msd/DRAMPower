...
void LPDDR4Core::doCommand(const Command& cmd) {
    ...
    switch(cmd.type) {
        case CmdType::ACT:
            util::coreHelpers::bankHandler(cmd, m_offset, m_ranks, m_helperMapping, &LPDDR4Core::handleAct, this);
            break;
        case CmdType::PRE:
            util::coreHelpers::bankHandler(cmd, m_offset, m_ranks, m_helperMapping, &LPDDR4Core::handlePre, this);
            break;
        case CmdType::PREA:
            util::coreHelpers::groupHandler(cmd, m_offset, m_ranks, m_helperMapping, &LPDDR4Core::handlePreAll, this);
            break;
        case CmdType::REFB:
            util::coreHelpers::bankHandlerIdx(cmd, m_offset, m_ranks, m_helperMapping, &LPDDR4Core::handleRefPerBank, this);
            break;
        case CmdType::RD:
            util::coreHelpers::bankHandler(cmd, m_offset, m_ranks, m_helperMapping, &LPDDR4Core::handleRead, this);
            break;
        case CmdType::RDA:
            util::coreHelpers::bankHandlerIdx(cmd, m_offset, m_ranks, m_helperMapping, &LPDDR4Core::handleReadAuto, this);
            break;
        case CmdType::WR:
            util::coreHelpers::bankHandler(cmd, m_offset, m_ranks, m_helperMapping, &LPDDR4Core::handleWrite, this);
            break;
        case CmdType::WRA:
            util::coreHelpers::bankHandlerIdx(cmd, m_offset, m_ranks, m_helperMapping, &LPDDR4Core::handleWriteAuto, this);
            break;
        case CmdType::REFA:
            util::coreHelpers::groupHandlerIdx(cmd, m_offset, m_ranks, m_helperMapping, &LPDDR4Core::handleRefAll, this);
            break;
        case CmdType::PDEA:
            util::coreHelpers::groupHandlerIdx(cmd, m_offset, m_ranks, m_helperMapping, &LPDDR4Core::handlePowerDownActEntry, this);
            break;
        case CmdType::PDXA:
            util::coreHelpers::groupHandlerIdx(cmd, m_offset, m_ranks, m_helperMapping, &LPDDR4Core::handlePowerDownActExit, this);
            break;
        case CmdType::PDEP:
            util::coreHelpers::groupHandlerIdx(cmd, m_offset, m_ranks, m_helperMapping, &LPDDR4Core::handlePowerDownPreEntry, this);
            break;
        case CmdType::PDXP:
            util::coreHelpers::groupHandlerIdx(cmd, m_offset, m_ranks, m_helperMapping, &LPDDR4Core::handlePowerDownPreExit, this);
            break;
        case CmdType::SREFEN:
            util::coreHelpers::groupHandlerIdx(cmd, m_offset, m_ranks, m_helperMapping, &LPDDR4Core::handleSelfRefreshEntry, this);
            break;
        case CmdType::SREFEX:
            util::coreHelpers::groupHandler(cmd, m_offset, m_ranks, m_helperMapping, &LPDDR4Core::handleSelfRefreshExit, this);
            break;
