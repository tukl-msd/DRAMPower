...
void DDR5Core::doCommand(const Command& cmd) {
    ...
    switch(cmd.type) {
        case CmdType::ACT:
            util::coreHelpers::bankHandler(cmd, m_offset, m_ranks, this, &DDR5Core::handleAct);
            break;
        case CmdType::PRE:
            util::coreHelpers::bankHandler(cmd, m_offset, m_ranks, this, &DDR5Core::handlePre);
            break;
        case CmdType::RD:
            util::coreHelpers::bankHandler(cmd, m_offset, m_ranks, this, &DDR5Core::handleRead);
            break;
        case CmdType::RDA:
            util::coreHelpers::bankHandlerIdx(cmd, m_offset, m_ranks, this, &DDR5Core::handleReadAuto);
            break;
        case CmdType::WR:
            util::coreHelpers::bankHandler(cmd, m_offset, m_ranks, this, &DDR5Core::handleWrite);
            break;
        case CmdType::WRA:
            util::coreHelpers::bankHandlerIdx(cmd, m_offset, m_ranks, this, &DDR5Core::handleWriteAuto);
            break;
        case CmdType::PRESB:
            util::coreHelpers::bankGroupHandler(cmd, m_offset, m_ranks, this, &DDR5Core::handlePreSameBank);
            break;
        case CmdType::REFSB:
            util::coreHelpers::bankGroupHandlerIdx(cmd, m_offset, m_ranks, this, &DDR5Core::handleRefSameBank);
            break;
        case CmdType::REFA:
            util::coreHelpers::rankHandlerIdx(cmd, m_offset, m_ranks, this, &DDR5Core::handleRefAll);
            break;
        case CmdType::PREA:
            util::coreHelpers::rankHandler(cmd, m_offset, m_ranks, this, &DDR5Core::handlePreAll);
            break;
        case CmdType::SREFEN:
            util::coreHelpers::rankHandlerIdx(cmd, m_offset, m_ranks, this, &DDR5Core::handleSelfRefreshEntry);
            break;
        case CmdType::SREFEX:
            util::coreHelpers::rankHandler(cmd, m_offset, m_ranks, this, &DDR5Core::handleSelfRefreshExit);
            break;
        case CmdType::PDEA:
            util::coreHelpers::rankHandlerIdx(cmd, m_offset, m_ranks, this, &DDR5Core::handlePowerDownActEntry);
            break;
        case CmdType::PDEP:
            util::coreHelpers::rankHandlerIdx(cmd, m_offset, m_ranks, this, &DDR5Core::handlePowerDownPreEntry);
            break;
        case CmdType::PDXA:
            util::coreHelpers::rankHandlerIdx(cmd, m_offset, m_ranks, this, &DDR5Core::handlePowerDownActExit);
            break;
        case CmdType::PDXP:
            util::coreHelpers::rankHandlerIdx(cmd, m_offset, m_ranks, this, &DDR5Core::handlePowerDownPreExit);
            break;
        case CmdType::NOP:
