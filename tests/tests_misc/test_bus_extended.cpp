...
TEST_F(ExtendedBusIdlePatternTest, EmptyIdleLow_1)
{
	...
	Bus_8 bus(1, Bus_8::BusIdlePatternSpec::L, Bus_8::BusInitPatternSpec::L);
...
TEST_F(ExtendedBusIdlePatternTest, EmptyIdleLow_2)
{
	...
	Bus_8::burst_t burst_custom;
	Init<8>(burst_ones, burst_zeroes, burst_custom);
	Bus_8 bus(1, Bus_8::BusIdlePatternSpec::L, Bus_8::BusInitPatternSpec::H);
...
TEST_F(ExtendedBusIdlePatternTest, EmptyIdleLow_3)
{
	...
	Bus_8::burst_t burst_custom;
	Init<8>(burst_ones, burst_zeroes, burst_custom);
	Bus_8 bus(1, Bus_8::BusIdlePatternSpec::L, burst_custom);
...
TEST_F(ExtendedBusIdlePatternTest, EmptyIdleHigh_1)
{
	...
	Bus_8::burst_t burst_custom;
	Init<8>(burst_ones, burst_zeroes, burst_custom);
	Bus_8 bus(1, Bus_8::BusIdlePatternSpec::H, Bus_8::BusInitPatternSpec::L);
...
TEST_F(ExtendedBusIdlePatternTest, EmptyIdleHigh_2)
{
	...
	Bus_8::burst_t burst_custom;
	Init<8>(burst_ones, burst_zeroes, burst_custom);
	Bus_8 bus(1, Bus_8::BusIdlePatternSpec::H, Bus_8::BusInitPatternSpec::H);
...
TEST_F(ExtendedBusIdlePatternTest, EmptyIdleHigh_3)
{
	...
	Bus_8::burst_t burst_custom;
	Init<8>(burst_ones, burst_zeroes, burst_custom);
	Bus_8 bus(1, Bus_8::BusIdlePatternSpec::H, burst_custom);
...
TEST_F(ExtendedBusIdlePatternTest, EmptyIdleLastPattern_1)
{
	...
	Bus_8::burst_t burst_custom;
	Init<8>(burst_ones, burst_zeroes, burst_custom);
	Bus_8 bus(1, Bus_8::BusIdlePatternSpec::LAST_PATTERN, Bus_8::BusInitPatternSpec::L);
...
TEST_F(ExtendedBusIdlePatternTest, EmptyIdleLastPattern_2)
{
	...
	Bus_8::burst_t burst_custom;
	Init<8>(burst_ones, burst_zeroes, burst_custom);
	Bus_8 bus(1, Bus_8::BusIdlePatternSpec::LAST_PATTERN, Bus_8::BusInitPatternSpec::H);
...
TEST_F(ExtendedBusIdlePatternTest, EmptyIdleLastPattern_3)
{
	...
	Bus_8::burst_t burst_custom;
	Init<8>(burst_ones, burst_zeroes, burst_custom);
	Bus_8 bus(1, Bus_8::BusIdlePatternSpec::LAST_PATTERN, burst_custom);
...
TEST_F(ExtendedBusIdlePatternTest, Load_Width_64)
{
	...
	Bus_64 bus(1, Bus_64::BusIdlePatternSpec::L, Bus_64::BusInitPatternSpec::L);
	std::array<uint8_t, number_bytes> data = { 0 }; 
	
	auto expected = Bus_64::burst_t();
...
TEST_F(ExtendedBusIdlePatternTest, Load_Width_512)
{
	...
	Bus_512 bus(1, Bus_512::BusIdlePatternSpec::L, Bus_512::BusInitPatternSpec::L);
	std::array<uint8_t, number_bytes> data = { 0 }; 
	
	auto expected = Bus_512::burst_t();
...
TEST_F(ExtendedBusStatsTest, Stats_Pattern_Datarate_1)
{
	...
	Bus_128 bus(datarate, Bus_128::BusIdlePatternSpec::L, Bus_128::BusInitPatternSpec::L);
...
{
	Bus_128::burst_t burst_ones;
	Bus_128::burst_t burst_zeroes;
	Bus_128::burst_t burst_custom;
	Init<128>(burst_ones, burst_zeroes, burst_custom);

	Bus_128 bus(1, Bus_128::BusIdlePatternSpec::L, burst_custom);
...
TEST_F(ExtendedBusStatsTest, Stats_Pattern_2)
{
	...
	Bus_128 bus(1, Bus_128::BusIdlePatternSpec::LAST_PATTERN, burst_custom);
	std::size_t custom_ones = burst_custom.count();
	std::size_t custom_zeroes = buswidth - custom_ones;
	uint8_t burst_ones_data[bus_array_size];
	std::fill_n(burst_ones_data, bus_array_size, 0xFF);
