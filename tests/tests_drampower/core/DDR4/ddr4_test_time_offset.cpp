...
class DramPowerTest_DDR4_16 : public ::testing::Test {
protected:
    // Test pattern
	std::vector<Command> testPattern = {
		{  0 + 1'000'000,  CmdType::ACT, { 0,0,0} },
		{  5 + 1'000'000,  CmdType::PDEA },
		{ 30 + 1'000'000,  CmdType::PDXA },
		{ 40 + 1'000'000,  CmdType::PRE, {0,0,0} },
		{ 45 + 1'000'000,  CmdType::PDEP },
		{ 65 + 1'000'000,  CmdType::PDXP },
		{ 75 + 1'000'000,  CmdType::REFA },
		{ 85 + 1'000'000,  CmdType::PDEP },
		{ 90 + 1'000'000,  CmdType::PDXP },
...
TEST_F(DramPowerTest_DDR4_16, Reset)
{
...
TEST_F(DramPowerTest_DDR4_16, Test)
{
	for (const auto& command : testPattern) {
		ddr->doCoreCommand(command);
	};
...
TEST_F(DramPowerTest_DDR4_16, CalcWindow)
{
	...
	// Cycle 5
	window = iterate_to_timestamp(command, 5 + 1'000'000);
	...
	// Cycle 10
	window = iterate_to_timestamp(command, 10 + 1'000'000);
	...
	// Cycle 15
	window = iterate_to_timestamp(command, 15 + 1'000'000);
	...
	// Cycle 20
	window = iterate_to_timestamp(command, 20 + 1'000'000);
	...
	// Cycle 25
	window = iterate_to_timestamp(command, 25 + 1'000'000);
	ASSERT_EQ(window.rank_total[0].cycles.act, 20);
	...
	// Cycle 30
	window = iterate_to_timestamp(command, 30 + 1'000'000);
	ASSERT_EQ(window.rank_total[0].cycles.act, 20);
	...
	// Cycle 35
	window = iterate_to_timestamp(command, 35 + 1'000'000);
	...
	// Cycle 40
	window = iterate_to_timestamp(command, 40 + 1'000'000);
	...
	// Cycle 45
	window = iterate_to_timestamp(command, 45 + 1'000'000);
	...
	// Cycle 50
	window = iterate_to_timestamp(command, 50 + 1'000'000);
	...
	// Cycle 55
	window = iterate_to_timestamp(command, 55 + 1'000'000);
	...
	// Cycle 60
	window = iterate_to_timestamp(command, 60 + 1'000'000);
	...
	// Cycle 65
	window = iterate_to_timestamp(command, 65 + 1'000'000);
	ASSERT_EQ(window.rank_total[0].cycles.act, 30);    ASSERT_EQ(window.rank_total[0].cycles.pre, 20);
	...
	// Cycle 70
	window = iterate_to_timestamp(command, 70 + 1'000'000);
	...
	// Cycle 75
	window = iterate_to_timestamp(command, 75 + 1'000'000);
	...
	// Cycle 80
	window = iterate_to_timestamp(command, 80 + 1'000'000);
	...
	// Cycle 85
	window = iterate_to_timestamp(command, 85 + 1'000'000);
	...
	// Cycle 90
	window = iterate_to_timestamp(command, 90 + 1'000'000);
	...
	// Cycle 95
	window = iterate_to_timestamp(command, 95 + 1'000'000);
	...
	// Cycle 100
	window = iterate_to_timestamp(command, 100 + 1'000'000);
	...
	// Cycle 105
	window = iterate_to_timestamp(command, 105 + 1'000'000);
	...
	// Cycle 110
	window = iterate_to_timestamp(command, 110 + 1'000'000);
	...
	// Cycle 115
	window = iterate_to_timestamp(command, 115 + 1'000'000);
	...
	// Cycle 120
	window = iterate_to_timestamp(command, 120 + 1'000'000);
	...
	// Cycle 125
	window = iterate_to_timestamp(command, 125 + 1'000'000);
...
TEST_F(DramPowerTest_DDR4_16, CalcEnergy)
{
