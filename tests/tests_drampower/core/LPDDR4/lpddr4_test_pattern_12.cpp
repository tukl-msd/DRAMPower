...
protected:
	...
	std::vector<Command> testPattern = {
		...
		{   5, CmdType::ACT, { 0, 1, 0, 0} },
		{  10, CmdType::ACT, { 0, 2, 0, 0} },
		{  15, CmdType::ACT, { 0, 3, 0, 0} },
		{  20, CmdType::ACT, { 0, 4, 0, 0} },
		{  25, CmdType::ACT, { 0, 5, 0, 0} },
		{  30, CmdType::ACT, { 0, 6, 0, 0} },
		{  35, CmdType::ACT, { 0, 7, 0, 0} },
		{  35, CmdType::RD,  { 0, 0, 0, 0} },
		{  40, CmdType::RD,  { 0, 0, 0, 0} },
		{  40, CmdType::RD,  { 0, 1, 0, 0} },
		{  45, CmdType::RD,  { 0, 0, 0, 0} },
		{  45, CmdType::RD,  { 0, 2, 0, 0} },
		{  50, CmdType::RD,  { 0, 3, 0, 0} },
		{  55, CmdType::RD,  { 0, 4, 0, 0} },
		{  60, CmdType::RD,  { 0, 5, 0, 0} },
		{  65, CmdType::RD,  { 0, 6, 0, 0} },
		{  70, CmdType::RD,  { 0, 7, 0, 0} },
		{  75, CmdType::RD,  { 0, 7, 0, 0} },
		{  80, CmdType::RD,  { 0, 7, 0, 0} },
		{  85, CmdType::WR,  { 0, 7, 0, 0} },
		{  90, CmdType::WR,  { 0, 6, 0, 0} },
		{  95, CmdType::WR,  { 0, 5, 0, 0} },
		{ 100, CmdType::WR,  { 0, 4, 0, 0} },
		{ 105, CmdType::WR,  { 0, 3, 0, 0} },
		{ 110, CmdType::WR,  { 0, 2, 0, 0} },
		{ 110, CmdType::WR,  { 0, 0, 0, 0} },
		{ 115, CmdType::WR,  { 0, 1, 0, 0} },
		{ 115, CmdType::RD,  { 0, 0, 0, 0} },
		{ 120, CmdType::WR,  { 0, 0, 0, 0} },
