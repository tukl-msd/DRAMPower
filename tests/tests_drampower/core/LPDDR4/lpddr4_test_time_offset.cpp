...
class DramPowerTest_LPDDR4_19 : public ::testing::Test {
protected:
    // Test pattern
	std::vector<Command> testPattern = {
		{  0 + 1'000'000, CmdType::REFA },
		{  5 + 1'000'000, CmdType::PDEP },
		{ 15 + 1'000'000, CmdType::PDXP },
		{ 30 + 1'000'000, CmdType::REFB, { 0,0,0} },
		{ 40 + 1'000'000, CmdType::ACT, { 1,0,0,}},
		{ 45 + 1'000'000, CmdType::PDEA },
		{ 75 + 1'000'000, CmdType::PDXA },
...
TEST_F(DramPowerTest_LPDDR4_19, Reset)
{
...
TEST_F(DramPowerTest_LPDDR4_19, Test)
{
	for (const auto& command : testPattern) {
		ddr->doCoreCommand(command);
	};
...
TEST_F(DramPowerTest_LPDDR4_19, CalcWindow)
{
...
TEST_F(DramPowerTest_LPDDR4_19, CalcEnergy)
{
