...
TEST_F(DramPowerTest_LPDDR5_15, CalcEnergy)
{
    ...
    ASSERT_EQ((int)total_energy.E_act, 1600);
    ...
    ASSERT_EQ(std::round(total_energy.E_bg_act), 3840);
    ASSERT_EQ(std::round(energy.E_bg_act_shared), 1680);
    ASSERT_EQ((int)energy.bank_energy[0].E_bg_act, 1600);
    ASSERT_EQ((int)energy.bank_energy[1].E_bg_act, 240);
    ASSERT_EQ((int)energy.bank_energy[2].E_bg_act, 160);
    ASSERT_EQ((int)energy.bank_energy[3].E_bg_act, 160);
