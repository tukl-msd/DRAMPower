...
class DramPowerTest_LPDDR6_14 : public ::testing::Test {
protected:
    // Test pattern
...
TEST_F(DramPowerTest_LPDDR6_14, Test)
{
...
TEST_F(DramPowerTest_LPDDR6_14, CalcEnergy)
{
    ...
    ASSERT_EQ(std::round(energy.E_bg_act_shared*1e12), 2720);
    ...
    ASSERT_EQ(std::round(total_energy.E_RDA*1e12), 1126);
    ASSERT_EQ(std::round(energy.bank_energy[0].E_RDA*1e12), 282);
    ASSERT_EQ(std::round(energy.bank_energy[1].E_RDA*1e12), 282);
    ASSERT_EQ(std::round(energy.bank_energy[2].E_RDA*1e12), 563);
    ...
    ASSERT_EQ(std::round(total_energy.E_WRA*1e12), 1421);
    ASSERT_EQ(std::round(energy.bank_energy[0].E_WRA*1e12), 947);
    ASSERT_EQ(std::round(energy.bank_energy[1].E_WRA*1e12), 474);
