...
class DramPowerTest_LPDDR6_20 : public ::testing::Test {
protected:
    // Test pattern
    ...
    virtual void SetUp()
    {
		...
		memSpec->memTimingSpec.tRCDR = 20;
		memSpec->memTimingSpec.tRCDW = 20;
		memSpec->memTimingSpec.tRFCDB = 25;
		memSpec->memTimingSpec.tRFCAB = 25;
		...
		memSpec->memPowerSpec[0].iDD5PDBX = 30e-3;
...
TEST_F(DramPowerTest_LPDDR6_20, Test)
{
...
TEST_F(DramPowerTest_LPDDR6_20, CalcWindow)
{
...
TEST_F(DramPowerTest_LPDDR6_20, CalcEnergy)
{
	// TODO verify
    ...
    ASSERT_EQ(std::round(total_energy.E_bg_act*1e12), 10000);
    ...
    ASSERT_EQ(std::round(energy.bank_energy[0].E_bg_pre*1e12), 3);
    ASSERT_EQ(std::round(energy.bank_energy[1].E_bg_pre*1e12), 3);
    ASSERT_EQ(std::round(energy.bank_energy[2].E_bg_pre*1e12), 3);
    ASSERT_EQ(std::round(energy.bank_energy[3].E_bg_pre*1e12), 3);
    ASSERT_EQ(std::round(energy.bank_energy[4].E_bg_pre*1e12), 3);
    ASSERT_EQ(std::round(energy.bank_energy[5].E_bg_pre*1e12), 3);
    ASSERT_EQ(std::round(energy.bank_energy[6].E_bg_pre*1e12), 3);
    ASSERT_EQ(std::round(energy.bank_energy[7].E_bg_pre*1e12), 3);
