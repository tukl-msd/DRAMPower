...
TEST_F(DramPowerTest_LPDDR6_17, Test)
{
	...
	ASSERT_EQ(stats.bank[8].counter.refPerTwoBanks, 2);

	ASSERT_EQ(stats.bank[1].counter.refPerTwoBanks, 1);
	ASSERT_EQ(stats.bank[4].counter.refPerTwoBanks, 1);
	ASSERT_EQ(stats.bank[9].counter.refPerTwoBanks, 1);
	ASSERT_EQ(stats.bank[12].counter.refPerTwoBanks, 1);
...
TEST_F(DramPowerTest_LPDDR6_17, CalcEnergy)
{
	...
	ASSERT_EQ(std::round(energy.bank_energy[2].E_ref_2B*1e12), 0);
	ASSERT_EQ(std::round(energy.bank_energy[3].E_ref_2B*1e12), 0);
	ASSERT_EQ(std::round(energy.bank_energy[4].E_ref_2B*1e12), 125);
	ASSERT_EQ(std::round(energy.bank_energy[5].E_ref_2B*1e12), 0);
	ASSERT_EQ(std::round(energy.bank_energy[6].E_ref_2B*1e12), 0);
