...
class DramPowerTest_LPDDR6_12 : public ::testing::Test {
protected:
    // Test pattern
...
TEST_F(DramPowerTest_LPDDR6_12, Pattern1)
{
	...
	// Inspect first rank
	const auto & rank_1 = internal::LPDDR6TestAccessor.getRanks(ddr->getCore()).at(0);
...
TEST_F(DramPowerTest_LPDDR6_12, CalcEnergy)
{
