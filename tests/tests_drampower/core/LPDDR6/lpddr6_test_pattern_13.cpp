...
class DramPowerTest_LPDDR6_13 : public ::testing::Test {
protected:
    // Test pattern
...
TEST_F(DramPowerTest_LPDDR6_13, Pattern_2)
{
	...
	// Inspect first rank
	const Rank & rank_1 = internal::LPDDR6TestAccessor.getRanks(ddr->getCore()).at(0);
...
TEST_F(DramPowerTest_LPDDR6_13, CalcEnergy)
{
