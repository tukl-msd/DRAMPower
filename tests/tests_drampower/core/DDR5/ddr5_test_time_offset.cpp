...
class DramPowerTest_DDR5_19 : public ::testing::Test {
protected:
    // Test pattern
...
TEST_F(DramPowerTest_DDR5_19, Reset)
{
...
TEST_F(DramPowerTest_DDR5_19, Test)
{
	for (const auto& command : testPattern) {
		ddr->doCoreCommand(command);
	};
...
TEST_F(DramPowerTest_DDR5_19, CalcWindow)
{
...
TEST_F(DramPowerTest_DDR5_19, CalcEnergy)
{
